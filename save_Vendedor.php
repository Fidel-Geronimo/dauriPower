...
if (isset($_POST['boton'])) {
  if ($_POST['nombre'] == "" || $_POST['telefono'] == "" || $_POST['direccion'] == "") { ?>
    ...
    $queriConfirmacion = "SELECT * from vendedores where telefono = $telefono";
    ...
    ?>
      <script>
        Swal.fire({
          title: "Error",
          text: "Este vendedor ya existe, se llama <?php echo $row["nombre"] ?>",
          confirmButtonText: "Aceptar",
          confirmButtonColor: '#007bff',
          icon: 'error'
        }).then(function() {
    ...
    <?php  } else {
      $query = "INSERT INTO vendedores(nombre, telefono, direccion, comentario) VALUES('$nombre','$telefono','$direccion','$comentario')";
